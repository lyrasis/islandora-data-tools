...
config = {
  ...
  'mods:originInfo' => {
  #   'self' => ['@eventType'],
  #   'mods:copyrightDate' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
  #   'mods:dateCaptured' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
     'mods:dateCreated' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
     'mods:dateIssued' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
     'mods:dateOther' => ['value', '@type', '@encoding', '@keyDate', '@qualifier'],
  #   'mods:dateModified' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
  #   'mods:dateValid' => ['value', '@encoding', '@keyDate', '@point', '@qualifier'],
  #   'mods:edition' => ['value'],
